...
__conda_setup="$('/home/discord/.miniconda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/discord/.miniconda/etc/profile.d/conda.sh" ]; then
        . "/home/discord/.miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/home/discord/.miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
